...
class CrowdsourcingV4Strategy:
    ...
    def __init__(self, config: Optional[Dict] = None):
        ...
        # 🔧 初始化5大核心能力
        self.enhancer = BeidouToolEnhancer(tool_name="crowdsourcing", tool_type="task_farming")
    ...
    async def mirofish_select(self, candidates: List[Dict] = None, strategy: str = "balanced", top_n: int = 5) -> List[Dict]:
        ...
        if candidates is None:
            candidates = [{"id": p, "score": 0.5} for p in self.platforms]
    ...
    async def scan_with_all_capabilities(self, mode: str = "auto") -> Dict:
        ...
        candidates = [
            ...
            for p, r in zip(self.platforms, global_results)
        ]
